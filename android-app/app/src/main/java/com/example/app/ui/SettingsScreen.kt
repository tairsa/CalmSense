...
/**
 * Settings tab. First (and currently only) section is the detection
 * sensitivity dial; profile settings (name, language, password) will join it
 * once user accounts land.
 */
@Composable
fun SettingsScreen() {
    Column(
